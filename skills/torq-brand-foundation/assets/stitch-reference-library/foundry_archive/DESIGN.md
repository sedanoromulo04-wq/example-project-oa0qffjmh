...
_Director's Note: Every pixel in this system should feel like it was placed by a curator, not a generator. If a design feels "busy," remove an element. If it feels "weak," increase the typographic scale. Silence is your most powerful tool._```
````
