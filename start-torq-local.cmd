...
start "Torq Jarvis Backend" powershell -NoExit -Command "Set-Location '%BACKEND%'; npm start"
start "Torq Jarvis Frontend" powershell -NoExit -Command "Set-Location '%FRONTEND%'; npm run dev -- --host 127.0.0.1"
