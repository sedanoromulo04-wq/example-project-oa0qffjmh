...
# Tom de Voz Torq — Guia de Calibração

> Este arquivo é atualizado continuamente com base nas transcrições de conversas reais do Yan e do Romulo. Representa o padrão real de comunicação da marca — não a versão aspiracional, mas a versão **como ela realmente soa**.
...
## O Que o Tom Torq NÃO É

- NÃO é motivacional ("você consegue!", "acredite no processo!")
- NÃO é acadêmico demais (evite linguagem de paper científico)
- NÃO é guru de Instagram (sem frases de efeito soltas)
- NÃO é consultoria genérica de slide (sem afirmações sem âncora)
- NÃO é agressivo ou provocativo (sem "a maioria das empresas erra aqui")
...
- "Isso funciona porque {lógica explícita}, não porque {intuição genérica}."
...
- "Incrível", "extraordinário", "fantástico" — evite superlativos emocionais
- "Guru", "expert", "especialista" — preferir o nome real da competência
- "Transformador", "revolucionário" — inflamado e vago
- "Simplesmente", "basicamente" — minimizadores que enfraquecem a afirmação
- "Como você sabe" — condescendente
- "Mágica", "segredo", "hack" — linguagem de marketing de massa

---

## Seção de Exemplos Reais

> Esta seção cresce com as transcrições. Cada exemplo registra como o Yan ou o Romulo expressaram algo — e como isso se traduz em copy/conteúdo Torq.
...
ADAPTAÇÃO TORQ:
"[versão editada para manter o tom mas adequar ao meio escrito]"

NOTA:
[O que caracteriza esse padrão e quando usá-lo]
```
