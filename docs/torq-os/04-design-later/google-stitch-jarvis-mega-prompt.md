...
date: 2026-04-07
tags: [torq-os, jarvis, frontend, design, google-stitch]
relevance: high
---

# Google Stitch Mega Prompt - Torq Jarvis Frontend

## Copy-paste prompt

Use the block below directly in Google Stitch.
...
- If Stitch returns something too much like a chatbot, push it harder toward
  "mission control" and "executive operating system".
- If it gets too futuristic or noisy, ask for a quieter, more premium, more
  editorial refinement.
- If it becomes too generic, reinforce:
  "This is not SaaS analytics. This is an AI operating cockpit."
