      ...
      >
        ...
        {pendingHistoricalActions > 0 && (
          <div className="jarvis-confirmation-banner">
            Existem {pendingHistoricalActions} proposta(s) antiga(s) pendentes nesta sessao. Elas
            nao serao aprovadas por este modal.
          </div>
        )}
        ...
        <div className="jarvis-confirmation-foot">
          <p>
            A decisao agora persiste no backend, atualiza `jarvis_actions` e registra a trilha de
            auditoria.
          </p>
