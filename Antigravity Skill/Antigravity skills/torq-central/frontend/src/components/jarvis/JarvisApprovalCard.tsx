...
export default function JarvisApprovalCard({
  response,
  reviewableActions,
    ...
    <section className="jarvis-approval-card">
      ...
      {pendingHistoricalActions > 0 && (
        <p className="jarvis-approval-note">
          Existem {pendingHistoricalActions} proposta(s) pendente(s) de turnos anteriores. Esta
          revisao atua apenas no lote atual.
        </p>
      )}
