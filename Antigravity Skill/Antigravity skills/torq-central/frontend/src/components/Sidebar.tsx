    ...
    <aside className={`sidebar${IS_JARVIS_MODE ? ' jarvis-mode' : ''}`}>
      ...
      <nav className="sidebar-nav">
        <div className="sidebar-section sidebar-jarvis">
          <NavLink
            to="/jarvis"
            className={({ isActive }) => `sidebar-item sidebar-link${isActive ? ' active' : ''}`}
          >
            <HexagonIcon size={16} />
        ...
        {IS_JARVIS_MODE && (
          <div className="sidebar-mode-note">
            ...
            <span>
              O cockpit prioriza orquestracao, bloqueios, approvals e contexto operacional.
            </span>
          </div>
        )}
          ...
          return (
            <div key={cat.id} className="sidebar-section">
              ...
              >
                ...
                <ChevronRightIcon
                  size={14}
                  className={`sidebar-chevron-icon${isOpen ? ' open' : ''}`}
                />
              </button>
                ...
                <div className="sidebar-doc-list">
                  ...
                  {docs.map((doc) => (
                    <NavLink
                      ...
                      to={`/doc/${doc.id}`}
                      className={({ isActive }) =>
                        `sidebar-doc-item${isActive ? ' active-doc' : ''}`
                      }
                    >
