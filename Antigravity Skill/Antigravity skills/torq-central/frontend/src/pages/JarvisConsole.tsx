            ...
            <header className="jarvis-header">
                <div className="jarvis-header-copy">
                    ...
                    <p className="jarvis-subtitle">
                        O cockpit opera em texto primeiro, mostra rota, blockers, approvals e o proximo passo seguro
                ...
                <div className="jarvis-header-actions">
                    ...
                    {responseCard && <span className="jarvis-badge subtle">{responseCard.current_module}</span>}
                    <button className="btn-primary" onClick={handleNewSession}>Nova sessao</button>
                </div>
            </header>
            ...
            <div className="jarvis-layout">
                <aside className="jarvis-sessions">
                    ...
                    {!bootLoading && sessions.length === 0 && (
                        <p className="jarvis-empty">Nenhuma sessao ainda. Envie a primeira pergunta ao Jarvis.</p>
                    )}
                            ...
                            <div className="jarvis-transcript">
                                {messages.length === 0 && (
                                    <div className="jarvis-empty-card">
                                        ...
                                        <p>
                                            Pergunte em linguagem natural. Exemplo: "Qual o proximo movimento seguro
                                            para este cliente?"
                                        </p>
                                    </div>
                                )}
