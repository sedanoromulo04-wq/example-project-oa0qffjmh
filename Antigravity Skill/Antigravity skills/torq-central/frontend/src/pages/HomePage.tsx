...
export default function HomePage() {
    ...
    useEffect(() => {
        Promise.all([
            ...
            supabase.from('activity_log').select('*, profiles(full_name, email)').order('created_at', { ascending: false }).limit(15)
        ]).then(([catRes, actRes]) => {
            ...
            <div className="home-body">
                ...
                <aside className="home-feed">
                    ...
                    <div className="feed-list">
                        {activities.length === 0 && (
                            <p className="feed-empty">Nenhuma atividade ainda.</p>
                        )}
                        {activities.map(act => (
                            <div key={act.id} className="feed-item">
                                ...
                                <div className="feed-item-content">
                                    ...
                                    <span className="feed-item-entity">
                                        {act.entity_title}
                                    </span>
                                    {act.category_name && (
